...
void coinflip() {
    ...
    string flip;
    int maxflip = 2;
    int coinflip = rand() % maxflip;


    cout << "heads or tails" << endl;
    cout << "> ";
    cin >> flip;
    cout << "kolik chces vsadit na tuto stranu, k dispozici mas " << moners << "$" << endl;
    cout << "> ";
    cin >> coinflipmoners;
...
void nahodnecislo() {
    ...
    if (vsazenemoners > moners) {
        cout << "tolik penez ani nemas" << endl;
        nahodnecislo();
    }
    else {
...
void blackjack() {
    ...
    while (i < 2) {
        ...
        karty[lastpozicekarty] = karty52[pozicekarty];
    ...
    while (i < 2) {
        int pozicekarty = rand() % 52;
        ai_karty[lastpozice_ai] = karty52[pozicekarty];
...
void lick() {
    ...
    karty[lastpozicekarty] = karty52[randomkarta];
...
void ai_lick() {
    ...
    if (nahoda = 1 && ai_skore < 16) { 
        int randomkarta = rand() % 52;
        ai_karty[lastpozicekarty] = karty52[randomkarta];
